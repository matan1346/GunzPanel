...
function printItemResults(CharBy, CharVa, OpVa, SBut2, SBut3, SAItem, SDItem, SOItem, SelTime, TimeVa, Cat, Numb, IfR)
{
	//alert("OMG");
	var MyBut = 0;
	var urlToSend = 'radioBu=0&ItemID='+SAItem;
	if (SBut2.checked)
	{
		MyBut = SBut2.value;
		urlToSend = 'radioBu=1&ItemID='+SDItem;
	}
	else if (SBut3.checked)
	{
		MyBut = SBut3.value;
		urlToSend = 'radioBu=2&ItemID='+SOItem;
	}
	urlToSend += '&SelCh='+CharBy+"&ValCh="+CharVa+"&actOf="+OpVa+"&SelT="+SelTime+"&ValT="+TimeVa;
	
	
	var toOut = 'Results:<br />';
	toOut += 'Select Character Option: '+CharBy+"<br />";
	toOut += 'Character Value: '+CharVa+"<br />";
	toOut += 'Add/Remove: '+OpVa+"<br />";
	toOut += 'Button: '+MyBut+"<br />";
	toOut += 'Select Admin Item: '+SAItem+"<br />";
	toOut += 'Select Donator Item: '+SDItem+"<br />";
	toOut += 'Select Other Item: '+SOItem+"<br />";
	toOut += 'Select Time Option: '+SelTime+"<br />";
	toOut += 'Time Value: '+TimeVa;
	
	
	printResults(urlToSend, Cat, Numb, IfR)
	
	//document.getElementById("results6").innerHTML=toOut;
	//alert("URL: "+urlToSend);
